    ...
    <div class="align-items-center" style="margin-top: 62px;width: 100%;display: flex;justify-content: center">
        <div class="card-header" id="divall">
            <div class="form-group">
                <h6 class="m-0 font-weight-bold" style="color: #00529c;font-size: 25px;margin-left: 20px">Giấy xin phép</h6>
                <hr>
            </div>
            <div id="divconten" style="float: left;width: 100%" >
                ...
                <fieldset style="background: #fffcd5;margin-top: 10px">
                    ...
                    <div id="main-nv" class="input-group" style="align-items: center;width: 100%;height: 50px;flex-wrap: unset">
                        <div id="main-tg-3" class="input-group" style="align-items: center;height: 50px;;flex-wrap: unset">
                            <h6 style="font-size: 16px;font-family: Tahoma;width: 116px">Từ ngày <h6 style="color: red;margin: 0px;padding: 0px">*</h6>: </h6>
                            <input id="timestart" type="datetime-local" class="form-control" style="border-radius: 5px;margin-left: 10px;margin-right: 10px" value="<?php
                            date_default_timezone_set('Asia/Ho_Chi_Minh');
                            echo date('Y-m-d\T07:30');
                            ?>">
                        </div>
                        <div id="main-tg-3" class="input-group" style="align-items: center;height: 50px;flex-wrap: unset">
                            <h6 style="font-size: 16px;font-family: Tahoma;width: 116px">Đến ngày <h6 style="color: red;margin: 0px;padding: 0px">*</h6>: </h6>
                            <input id="timeend" type="datetime-local" class="form-control" style="border-radius: 5px;margin-left: 10px;margin-right: 10px" value="<?php
                            date_default_timezone_set('Asia/Ho_Chi_Minh');
                            echo date('Y-m-d\T16:30');
                            ?>">
                        </div>
                    </div>
                    <div id="main-nv3" class="input-group" style="align-items: center;width: 100%;height: 50px;flex-wrap: unset">
                        <h6 style="font-size: 16px;font-family: Tahoma;width: 116px">Lý do nghỉ <h6 style="color: red;margin: 0px;padding: 0px">*</h6>: </h6>
                    ...
                    <div class="input-group" style="align-items: center;width: 100%;margin-top: 10px;height: 50px;flex-wrap: unset">
                        <h6 style="font-size: 16px;font-family: Tahoma;width: 116px">Nhân sự bàn giao<h6 style="color: red;margin: 0px;padding: 0px">*</h6>: </h6>
                        <input id="txtmember" type="text" class="form-control" style="border-radius: 5px;margin-left: 10px;margin-right: 10px">
                    </div>
                    <div class="input-group" style="align-items: center;width: 100%;margin-top: 10px;height: 50px;flex-wrap: unset">
            ...
            <div style="margin:auto;background-color:#fff;position:relative;padding:0;outline:0;width:850px;height: 650px">
                ...
                <div style="height: 523px;background: white" >
                    ...
                    <div style="display: flex;margin-left: 20px;margin-right: 20px;margin-top: 30px">
                        <div style="width: 50%">
                            <label style="text-align: center;font-size: 15px;font-family: Tahoma">XEM XÉT</label>
                        </div>
                        <div style="width: 50%">
...
<script>
    ...
    function Showreview()
    {
        if(document.getElementById('txtidmember').value=='' || document.getElementById('txtlydo').value=='' || document.getElementById('txtmember').value =='')
        {
            ...
            document.getElementById('lblposition').innerText = document.getElementById('txtposition').value;
            document.getElementById('lblreason').innerText = document.getElementById('txtlydo').value;
            document.getElementById('lblmember').innerText = document.getElementById('txtmember').value;
            document.getElementById('lblmember1').innerText = document.getElementById('txtmember').value;
            var nghiden = $('#timestart').val();
            ...
            nghiden = $('#timeend').val();
            nghiden_arry = nghiden.split("-");
            dennam = nghiden_arry[0];
            denthang = nghiden_arry[1];
            ngaygio_arry = nghiden_arry[2].split("T");
            denngay = ngaygio_arry[0];
            giophut_arry = ngaygio_arry[1].split(":");
            dengio = giophut_arry[0];
            denphut = giophut_arry[1];
            document.getElementById('lbltimein').innerText = dengio + " h " + denphut + " phút, Ngày " + denngay + "/" + denthang + "/" + dennam;
	...
	document.getElementById('btnSuccess').style.display='none';
        ...
        var result ={idmember,idfunction,reason,member,note,timestart,timeend,idcheck,idapprove};
        SaveFile(result);
    }
        ...
        $.ajax({
            ...
            success:function(result){
                ...
                else
                {
                    ...
                    var subject = "Trình duyệt giấy xin phép";
                    var link = "http://113.161.6.179:8089/RD/F0012.php?id="+result.result;
                    var idcheck = document.getElementById('check').value;
