                ...
                <div style="display: flex;min-width: 700px">
                    ...
                    <div class="form-group" style="width: 50%;align-items: center;float: right">
                        <div id="mf-menu-sl" style="position: absolute;right: 0px;margin-right: 20px;display: flex;align-items: center">
                            <button class="btn btn-success" type="button" onclick="document.getElementById('ppNewMember').style.display='block';$('#sldept1').val('<?php echo $iddept ?>');">Thêm nhân sự</button>
                        </div>
                    </div>
                </div>
                <hr>
                ...
                <div style="width: 100%;background: white;">
                    <table id="tableshow" class="table table-bordered align-items-center table-flush table-hover" style="background: white;color: black">
                        ...
                        <tr>
                            ...
                            <th style="background: #00529c;color: white;text-align: center">Mã số thẻ</th>
        ...
        <div style="margin:auto;background-color:#fff;position:relative;padding:0;outline:0;width:600px;height: 300px">
            <div class="table-responsive" style="float: left;background: white;" >
                <div class="navbar navbar-dark bg-dark">
                    <h5 class="navbar-brand">Chỉnh sửa thông tin dùng mới</h5>
                ...
                <div>
                    <table style="background: white;width: 100%;font-family: Tahoma;font-size: 14px" class="table align-items-center table-flush">
                        ...
                        <tr>
                            <td style="width: 200px">Mã số thẻ: </td>
                            <td><input name="txtidCard" style="width: 100%" id="txtidCard"></td>
                        </tr>
                        <tr>
                            <td style="width: 200px">Bộ phận: </td>
                            <td><select class="form-select" style="height: 30px;width: 200px;font-size: 14px;font-family: Tahoma" name="sldept" id="sldept" disabled></select></td>
                        </tr>
                        <tr>
            ...
            <div class="table-responsive" style="float: left;background: white;" >
                ...
                <div>
                    <table style="background: white;width: 100%;font-family: Tahoma;font-size: 14px" class="table align-items-center table-flush">
                        ...
                        <tr>
                            <td style="width: 200px">Mã số thẻ: </td>
                            <td><input name="txtidCard" style="width: 100%" id="txtidCard1"></td>
                        </tr>
                        <tr>
                            <td style="width: 200px">Bộ phận: </td>
                            <td><select class="form-select" style="height: 30px;width: 200px;font-size: 14px;font-family: Tahoma" name="sldept1" id="sldept1" disabled></select></td>
                        </tr>
                        <tr>
                            <td style="width: 200px">Địa chỉ Mail: </td>
...
<script type="text/javascript">
    ...
    function NewMember(){
        ...
        var result = {idmember,fullname,dept,mail,pass,position,idcard};
        console.log(result);
        SaveNew(result);
    }
        ...
        $.ajax({
            ...
            success:function (result)
            {
                ...
                for(var i=0;i<result.result.length;i++)
                {
                    ...
                    cell4.innerHTML = result.result[i].IDCard;
                    cell5.innerHTML = result.result[i].NameDept;
                    cell6.innerHTML = result.result[i].NamePosition;
                    cell7.innerHTML = result.result[i].Email;
                    cell8.innerHTML = result.result[i].Function;
                }
            },
            error:function (error){
                console.log(error.responseText);
        ...
        $.ajax({
            ...
            success: function (result) {
                if (typeof result.result == 'undefined') {
                    ...
                    document.getElementById('txtidCard').value = result.result[0]['IDCard'];
    ...
    function EditMember(){
        ...
        var result = {idmember,fullname,iddept,idposition,mail,pass,idcard};
        SaveEdit(result);
    }
