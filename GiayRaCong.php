    ...
    <div class="align-items-center" style="margin-top: 62px;width: 100%;display: flex;justify-content: center">
        <div class="card-header" id="divall">
            <div class="form-group">
                <h6 class="m-0 font-weight-bold" style="color: #00529c;font-size: 25px;margin-left: 20px">Giấy ra cổng</h6>
                <hr>
            </div>
                ...
                <fieldset style="background: #fffcd5;margin-top: 10px">
                    ...
                    <div id="main-nv" class="input-group" style="align-items: center;width: 100%;height: 50px;flex-wrap: unset">
                        ...
                        <div id="main-tg-2" class="input-group" style="align-items: center;height: 50px;flex-wrap: unset">
                            <h6 style="font-size: 16px;font-family: Tahoma;width: 124px;padding: unset">Thời gian vào<h6 style="color: red;margin: 0px;padding: 0px"></h6>: </h6>
                            ...
                            <div id="main-tg-4" class="input-group" style="align-items: center;width: 220px;flex-wrap: unset">
                                <input name="allow" id="chkallow" type="radio" checked onchange="$('#timeout').css('display','block')" style="margin-left: 10px">
                            <label for="chkallow" style="margin-right: 10px">Vào lại</label>
                            <input name="allow" id="chkNotallow" type="radio" onchange="$('#timeout').css('display','none')">
                            <label for="chkNotallow">Không vào lại</label>
                            </div>
                                <div id="main-tg-5" style="margin-right: 10px">
                                <input id="timeout" type="datetime-local" class="form-control" style="border-radius: 5px;width: 100%;" value="<?php
                            date_default_timezone_set('Asia/Ho_Chi_Minh');
                            echo date('Y-m-d\TH:i');
                            ?>">
                                </div>
                    ...
                    <div id="main-nv2" class="input-group" style="align-items: center;width: 100%;height: 50px">
                        <h6 style="font-size: 16px;font-family: Tahoma;width: 116px">Lý do ra cổng <h6 style="color: red;margin: 0px;padding: 0px">*</h6>: </h6>
        ...
        <div id="review" style="z-index:3;display:none;padding-top:70px;position:fixed;left:0;top:0;width:100%;height:100%;overflow:auto;background-color:rgb(0,0,0);background-color:rgba(0,0,0,0.4);border: 1px solid black">
            <div style="margin:auto;background-color:#fff;position:relative;padding:0;outline:0;width:600px;height: 580px">
                ...
                <div style="background: white;margin: auto;text-align: center;margin-top: 20px;">
...
<script>
    ...
    function Create()
    {
		document.getElementById('btnSuccess').style.display='none';
            ...
            var timein='';
            if($('#chkallow').is(':checked'))
                timein = document.getElementById('timeout').value;
            var idcheck = document.getElementById('check').value;
            var idapprove=document.getElementById('approve').value;
            var result ={idmember,idfunction,reason,licence,bring,note,timeout,timein,idcheck,idapprove};
            SaveFile(result);
    }
        ...
        $.ajax({
            ...
            success:function(result){
                ...
                else
                {
                    ...
                    var subject = "Trình duyệt giấy ra cổng";
		            var link = "http://113.161.6.179:8089/RD/F0011.php?id="+result.result;
                    var idcheck = document.getElementById('check').value;
